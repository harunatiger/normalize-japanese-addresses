...
declare const requestHandlers: {
    file: (fileURL: URL, options?: FetchOptions) => Promise<{
        json: () => Promise<any>;
        text: () => Promise<string>;
        ok: boolean;
    }>;
    http: (fileURL: URL, options?: FetchOptions) => Promise<undici.Response>;
};
declare const version: string;
declare const config: Config;
declare const normalize: Normalizer;

export { type NormalizeResult, config, normalize, requestHandlers, version };
